/* common.vapi generated by valac 0.26.1, do not modify. */
...
namespace Boxes {
	...
	public class BoxConfig : GLib.Object, Boxes.IConfig {
		...
		public void sync_properties (GLib.Object object, Boxes.BoxConfig.SyncProperty[] properties);
	...
	[CCode (cheader_filename = "libcommon.h")]
	public static async void run_in_thread (owned Boxes.RunInThreadFunc func) throws GLib.Error;
	[CCode (cheader_filename = "libcommon.h")]
